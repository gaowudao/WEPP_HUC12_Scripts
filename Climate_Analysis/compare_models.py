...
def compare_models(mod_rcps, HUC12_path):
    ...
    def analyze_trends(r19, r59, r99):
        ...
        trends_df = pd.DataFrame({'fall_pr':fall_trends[0:3], 'spring_pr':spring_trends[0:3],\
                                  'summer_pr':summer_trends[0:3], 'winter_pr':winter_trends[0:3],\
                                  'fall_R10':fall_trends[3:6],'spring_R10':spring_trends[3:6],\
                                  'summer_R10':summer_trends[3:6], 'winter_R10':winter_trends[3:6],\
                                  'fall_R25':fall_trends[6:9],'spring_R25':spring_trends[6:9],\
                                  'summer_R25':summer_trends[6:9], 'winter_R25':winter_trends[6:9]})
...
with pd.ExcelWriter('E:/Soil_Erosion_Project/WEPP_PRWs/ST1/ST1_climate_trends.xlsx') as writer:
