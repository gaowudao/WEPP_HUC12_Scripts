...
runs_dir = 'C:/Users/Garner/Soil_Erosion_Project/WEPP_PRWs/{}/Runs/Base/Obs/wepp/runs/'.format(wshed)
...
#return dataframe to HS_info
HS_info = find_rotations()
...
for ID, rot, OFE in zip(HS_info['ID'], HS_info['Rotation'], HS_info['OFE']):
    ...
    if 'Alf' in rot or 'Pasture' in rot:
        ...
        dest_dir = 'C:/Users/Garner/Soil_Erosion_Project/WEPP_PRWs/{}/New_Runs/Per_0/wepp/runs/'.format(wshed)
